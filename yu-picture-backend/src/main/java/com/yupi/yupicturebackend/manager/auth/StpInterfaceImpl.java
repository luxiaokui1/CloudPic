...
public class StpInterfaceImpl implements StpInterface {
    ...
    public List<String> getPermissionList(Object loginId, String loginType) {
        ...
        if (loginUser == null) {
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR, "User not logged in");
        }
        ...
        if (spaceUserId != null) {
            ...
            if (spaceUser == null) {
                throw new BusinessException(ErrorCode.NOT_FOUND_ERROR, "Space user not found");
            }
        ...
        if (spaceId == null) {
            ...
            Picture picture = pictureService.lambdaQuery()
                    ...
                    .one();
            if (picture == null) {
                throw new BusinessException(ErrorCode.NOT_FOUND_ERROR, "Picture not found");
            }
        ...
        if (space == null) {
            throw new BusinessException(ErrorCode.NOT_FOUND_ERROR, "Space not found");
        }
        // 根据 Space 类型判断权限
